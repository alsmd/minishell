...
SRCS_BONUS = $(PATH_MAIN_BONUS)main.c $(PATH_MAIN_BONUS)init.c $(PATH_MAIN_BONUS)clean_trash.c\
		...
		$(PATH_COMMAND_BONUS)relations.c $(PATH_COMMAND_BONUS)relations_helper_bonus.c $(PATH_COMMAND_BONUS)exec_helper.c\
		$(PATH_COMMAND_BONUS)make_commands.c\
		...
		$(PATH_PARSE_BONUS)expand_asterisk_helper.c\
		...
		$(PATH_UTILS_BONUS)ft_strlcpy.c $(PATH_UTILS_BONUS)compare.c $(PATH_UTILS_BONUS)join_matrix.c
